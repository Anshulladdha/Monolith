    ...
    <div className='bg-black text-white '>
        <div class="container text-center">
            <div class="flex justify-around py-10 ">
                <div class=" w-1/4">
                     <div className='text-sm'>{/*image */}
                        <img className='mr-3 h-6 sm:h-20' src={companyLogo}></img>
                    </div>
                    <p className='text-sm  py-3 text-justify '>Safety equipment includes a range of tools and devices that are designed to help prevent fires, detect them early, and extinguish them quickly.</p>
                    <div className='icons-container flex space-x-3 '>
                        ...
                        <i class="fa-brands fa-square-instagram text-xl "></i>
                        </div>
                        <div className=' cursor-pointer px-3 py-4 w-8 h-8  rounded-lg  flex justify-center items-center'>
                ...
                <div class="w-1/4 text-justify">
                    <h1>Address</h1>
                    <div className=' py-4 text-justify '>
                   <p> Plot No. 1107, First Floor, Sector 47, Sohna Road, Near ILD Mall, Gurgaon</p>   
